<# novoSYS Workplace Assessment - DE-CH HTML report #>
[CmdletBinding()]
...
$html=@'
<!doctype html><html lang="de-CH"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>novoSYS Workplace Assessment</title><link rel="icon" type="image/svg+xml" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64'%3E%3Crect width='64' height='64' rx='14' fill='%232f6df6'/%3E%3Ctext x='32' y='45' font-family='Segoe UI,Arial,sans-serif' font-size='28' font-weight='800' fill='white' text-anchor='middle'%3EnS%3C/text%3E%3C/svg%3E"><meta name="description" content="novoSYS Workplace Assessment - Offline Windows-Ger&auml;tezustands- und Sicherheitsbericht"><meta property="og:title" content="novoSYS Workplace Assessment"><style>
...
</style></head><body><div class="wrap"><div class="top"><div><div class="brand"><img src="data:image/svg+xml;base64," alt="novoSYS"><span>NOVOSYS WORKPLACE ASSESSMENT</span></div><div class="title" id="title"></div><div class="meta" id="meta"></div><div class="modeSwitch" id="modeSwitch"></div></div><div class="scoreBox"><div><div class="score" id="score">--%</div><div class="adjustedNote" id="adjustedNote" style="display:none"></div></div><div class="overallLabel" id="overallLabel"></div><button class="btn" onclick="window.print()" id="printBtn"></button></div></div><div id="err" class="error"></div><div class="cards" id="cards"></div><div class="section"><h2 id="sectionTitle"></h2><div class="hint" id="hint"></div><div class="tabs" id="tabs"></div><div class="tools"><input class="search" id="q" oninput="renderTable()"><button class="btn secondary" onclick="expandAll()" id="expandBtn"></button><button class="btn secondary" onclick="collapseAll()" id="collapseBtn"></button><button class="btn" onclick="downloadJson()" id="jsonBtn"></button></div><div style="overflow:auto;max-height:700px"><table><thead><tr><th id="thStatus"></th><th id="thCategory"></th><th id="thCheck"></th><th id="thScore"></th><th id="thEvidence"></th><th id="thRisk"></th><th id="thRecommendation"></th></tr></thead><tbody id="tbody"></tbody></table></div></div><div class="footer" id="footer"></div></div><script>
...
function ackKey(){return 'novosys-wpa-ack::'+data.computer}
...
function modeKey(){return 'novosys-wpa-devicemode::'+data.computer}
